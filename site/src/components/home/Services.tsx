import type { ServicesContent } from '@/lib/sanity/home'

export default function Services({ tag, title, items }: ServicesContent) {
  return (
    <section id="services" className="py-[88px] px-6">
      <div className="max-w-[1160px] mx-auto">
        <p className="text-xs font-semibold uppercase tracking-widest text-[#3b82f6] mb-3">{tag}</p>
        <h2 className="text-[2rem] font-bold text-[#f1f5f9] mb-4">{title}</h2>
