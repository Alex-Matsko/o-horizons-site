...
export default function Audits() {
  ...
  return (
    <section id="audits" className="py-20 px-6 bg-[#0a0c10]">
      <div className="max-w-[1160px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map(item => (
            <div key={item.title} className="bg-[#151820] border border-white/[0.07] rounded-2xl p-6 flex flex-col hover:border-white/20 transition-colors">
