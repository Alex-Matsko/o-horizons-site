      ...
      <div className="max-w-[1160px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-5">
          {data.items.map(plan => (
            <div
              key={plan.name}
              className="bg-[#151820] rounded-2xl p-8 flex flex-col border border-[rgba(255,255,255,0.07)] hover:border-[rgba(59,130,246,0.3)] transition-colors h-full"
            >
              ...
              <Link
                href="/calculator"
                className="w-full py-3 rounded-[10px] text-[0.9rem] font-semibold text-center transition-colors bg-[rgba(59,130,246,0.15)] text-[#3b82f6] border border-[rgba(59,130,246,0.3)] hover:bg-[rgba(59,130,246,0.25)]"
              >
                {data.cta}
              </Link>
            </div>
